...
from mjlab.asset_zoo.robots.xterra_dhav1.dhav1_constants import (
  DHAV1_ACTION_SCALE,
  DHAV1_ROBOT_CFG,
)
...
@dataclass
class xTerraDhav1RoughEnvCfg(LocomotionVelocityEnvCfg):
  def __post_init__(self):
    super().__post_init__()

    self.scene.entities = {"robot": replace(DHAV1_ROBOT_CFG)}
    ...
    # Actions.
    self.actions.joint_pos.scale = DHAV1_ACTION_SCALE
...
@dataclass
class xTerraDhav1RoughEnvCfg_PLAY(xTerraDhav1RoughEnvCfg):
  def __post_init__(self):
    super().__post_init__()
